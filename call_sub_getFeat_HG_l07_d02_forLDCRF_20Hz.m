...
%New frequency: 1000 / 50 = 20 Hz
fac_resample = round(50);
...
%             dataTrial_HG_post = zscore(dataTrial_HG_post,0,1);
    ...
    save(['data' filesep subject filesep subject '_dataTrial_HG_full_chop_forLDCRF_20Hz.mat'],'cell_trials_all','cell_labels_all','cell_correl_all','zonas');
end