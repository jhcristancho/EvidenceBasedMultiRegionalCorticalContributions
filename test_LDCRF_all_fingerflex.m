            ...
            %     numIt = [1 2 5 10 20 50 100];
                ...
                for winSize = 0:winMax
                    ...
                    %             return
                        ...
                        save(['data' filesep subject filesep subject '_' Type{eltipo} '_model_' upper(modelT) '_nHid_' num2str(maxStates(elstate)) '_SMreg_numIt' num2str(numIt(elC)) '_wDelay' num2str(nDelay) '_windowSize_' num2str(winSize) '_lpfreq_' num2str(lp_freq(lafreq)) '.mat'],'myAcc','C','dataTrial_HG_cell','stim_cell','numIt');
                    end
                end
            end
        end
