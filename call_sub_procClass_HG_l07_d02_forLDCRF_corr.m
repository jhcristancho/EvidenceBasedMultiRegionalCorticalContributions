...
for q=1:size(subjects,1)
    ...
    load(['data' filesep subject filesep subject '_dataTrial_HG_full_chop_forLDCRF_corr.mat'],'cell_trials_all','cell_labels_all','cell_correl_all');
                            ...
                            for posrho = 1:len_rho
                                ...
                                for lenwinsize = 1:len_winmax
                                    ...
                                    for postest = 1:num_train
                                        ...
                                        disp(['Number of hidden states: ' num2str(no_hidden) ', lambda value: ' num2str(myLambda) ', eta value: ' num2str(eta) ', rho value: ' num2str(rho_val) ', subtrial number ' num2str(postest) ', adjacent times: ' num2str(winvec) '...']);
...
%     toc;
    save(['data' filesep subject filesep subject '_dataTrial_HG_ldcrf_res_corr.mat'],'metric_all_corr','metric_all','testCP_all','testCP_all_corr');
end