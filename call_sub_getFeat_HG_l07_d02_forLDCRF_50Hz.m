...
%New frequency: 1000 / 20 = 50 Hz
fac_resample = round(20);
...
%             dataTrial_HG_post = zscore(dataTrial_HG_post,0,1);
    ...
    save(['data' filesep subject filesep subject '_dataTrial_HG_full_chop_forLDCRF_50Hz.mat'],'cell_trials_all','cell_labels_all','cell_correl_all','zonas');
end