...
for q=1:size(subjects,1)
    ...
    load(['data' filesep subject filesep subject '_dataTrial_HG_crf_res_corrzone.mat'],'metric_all_corr','metric_all','testCP_all','testCP_all_corr','zonas');
...
figure;
[anova_c13_acc,anova_m13_acc,anova_h13_acc,anova_gnames13_acc] = multcompare(anova_stats_acc,'dimension',[1 2 3],'ctype','hsd','display','on');
set(gcf,'Color','white');
xlabel('Accuracy','FontSize',14);
set(gca,'FontSize',14);
set(findall(gca, 'Type', 'Line'),'LineWidth',2);