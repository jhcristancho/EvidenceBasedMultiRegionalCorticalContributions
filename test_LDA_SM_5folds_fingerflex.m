...
%         params.weightsInitType = 'RANDOM';
        ...
        val_test = classify(dataTrial_HG_test,dataTrial_HG_train,stim_train);
    ...
    save(['data' filesep subject filesep subject '_LDA_SMreg_lpfreq_' num2str(lp_freq(lafreq)) '_V2_5.mat'],'avgAcc','dataTrial_HG_cell','stim_cell','testCP');
end