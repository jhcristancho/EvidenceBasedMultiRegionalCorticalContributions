...
%     return
    ...
    for curtw = 1:tw_len
        ...
        for curnd = 1:nd_len
            ...
            [corr_out,posi] = windslidecorr(data,winSize,sldSize,1);
...
%             dataTrial_HG_post = zscore(dataTrial_HG_post,0,1);
    ...
    save(['data' filesep subject filesep subject '_dataTrial_HG_full_chop_forLDCRF_corr.mat'],'cell_trials_all','cell_labels_all','cell_correl_all');
end