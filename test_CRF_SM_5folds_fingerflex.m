...
for q=1:size(subjects,1)
    ...
    for eltipo = 1:numel(Type)
        ...
        for nTrain = 1:numRounds
            ...
            toc;
            save(['data' filesep subject filesep subject '_' Type{eltipo} '_model_' upper(modelT) '_SMreg_numIt' num2str(numIt(elC)) '_lpfreq_' num2str(lp_freq(lafreq)) '_tmpRound_' num2str(nTrain) '.mat'],'tmpAcc','dataTrial_HG_train','dataTrial_HG_test','stim_train','stim_test','winMax','maxStates','myAcc','avgAcc','testCP');
        end
